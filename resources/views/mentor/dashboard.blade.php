            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-gradient-to-br from-red-600 to-red-800 rounded-2xl p-6 text-white shadow-xl shadow-red-200 relative overflow-hidden group hover:shadow-2xl transition-all">
                    ...
                    <div class="relative z-10">
                        ...
                        <a href="{{ route('mentor.students.index') }}" class="inline-flex items-center gap-1 mt-4 text-xs font-semibold bg-white/20 hover:bg-white/30 px-3 py-1 rounded-full text-white transition-colors">
                ...
                <!-- Card 3: Quick Grade -->
                <div class="bg-gradient-to-br from-red-600 to-red-800 rounded-2xl p-6 text-white shadow-xl shadow-red-200 relative overflow-hidden group hover:shadow-2xl transition-all flex flex-col justify-center items-center text-center">
                     <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
                     <div class="relative z-10 w-full flex flex-col items-center">
                        <div class="p-3 bg-white/20 rounded-full text-white mb-3 backdrop-blur-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                            </svg>
                        </div>
                        <h4 class="font-bold text-white">Evaluasi & Penilaian</h4>
                        <p class="text-xs text-red-100 mt-1 mb-3 max-w-[200px]">Berikan penilaian akhir untuk mahasiswa yang telah selesai.</p>
                    </div>
                </div>
            </div>
